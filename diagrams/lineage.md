...
graph TD
    ...
    class customers,order_items,orders,products table;
    class sp_get_customer_full_details,sp_transfer_funds,sp_get_customer_orders,sp_register_or_update_customer,sp_get_order_details,sp_create_order,sp_get_customer_by_id,sp_update_customer_email stored_proc;
