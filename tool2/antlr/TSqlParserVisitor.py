...
class TSqlParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by TSqlParser#open_cursor_statement.
    def visitOpen_cursor_statement(self, ctx:TSqlParser.Open_cursor_statementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by TSqlParser#fetch_cursor_statement.
    def visitFetch_cursor_statement(self, ctx:TSqlParser.Fetch_cursor_statementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by TSqlParser#close_cursor_statement.
    def visitClose_cursor_statement(self, ctx:TSqlParser.Close_cursor_statementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by TSqlParser#deallocate_cursor_statement.
    def visitDeallocate_cursor_statement(self, ctx:TSqlParser.Deallocate_cursor_statementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by TSqlParser#local_id.
    def visitLocal_id(self, ctx:TSqlParser.Local_idContext):
        return self.visitChildren(ctx)
