# Generated from antlr/TSqlParser.g4 by ANTLR 4.13.1
from antlr4 import *
if "." in __name__:
...
class TSqlParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by TSqlParser#open_cursor_statement.
    def enterOpen_cursor_statement(self, ctx:TSqlParser.Open_cursor_statementContext):
        pass

    # Exit a parse tree produced by TSqlParser#open_cursor_statement.
    def exitOpen_cursor_statement(self, ctx:TSqlParser.Open_cursor_statementContext):
        pass


    # Enter a parse tree produced by TSqlParser#fetch_cursor_statement.
    def enterFetch_cursor_statement(self, ctx:TSqlParser.Fetch_cursor_statementContext):
        pass

    # Exit a parse tree produced by TSqlParser#fetch_cursor_statement.
    def exitFetch_cursor_statement(self, ctx:TSqlParser.Fetch_cursor_statementContext):
        pass


    # Enter a parse tree produced by TSqlParser#close_cursor_statement.
    def enterClose_cursor_statement(self, ctx:TSqlParser.Close_cursor_statementContext):
        pass

    # Exit a parse tree produced by TSqlParser#close_cursor_statement.
    def exitClose_cursor_statement(self, ctx:TSqlParser.Close_cursor_statementContext):
        pass


    # Enter a parse tree produced by TSqlParser#deallocate_cursor_statement.
    def enterDeallocate_cursor_statement(self, ctx:TSqlParser.Deallocate_cursor_statementContext):
        pass

    # Exit a parse tree produced by TSqlParser#deallocate_cursor_statement.
    def exitDeallocate_cursor_statement(self, ctx:TSqlParser.Deallocate_cursor_statementContext):
        pass


    # Enter a parse tree produced by TSqlParser#local_id.
    def enterLocal_id(self, ctx:TSqlParser.Local_idContext):
        pass

    # Exit a parse tree produced by TSqlParser#local_id.
    def exitLocal_id(self, ctx:TSqlParser.Local_idContext):
        pass
